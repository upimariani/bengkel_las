...
<script src="<?= base_url('asset/amado-master/') ?>js/jquery/jquery-2.2.4.min.js"></script>
<!-- Popper js -->
<script src="<?= base_url('asset/amado-master/') ?>js/popper.min.js"></script>
<!-- Bootstrap js -->
<script src="<?= base_url('asset/amado-master/') ?>js/bootstrap.min.js"></script>
<!-- Plugins js -->
<script src="<?= base_url('asset/amado-master/') ?>js/plugins.js"></script>
<!-- Active js -->
<script src="<?= base_url('asset/amado-master/') ?>js/active.js"></script>
