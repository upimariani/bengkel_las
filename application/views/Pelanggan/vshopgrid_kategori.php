<div class="shop_sidebar_area">
    ...
    <div class="widget catagory mb-50">
        ...
        <div class="catagories-menu">
            <ul>
                <li class="active"><a href="<?= base_url('pelanggan/c_shopgrid') ?>">All</a></li>
                <?php
                foreach ($kategori as $key => $value) {
                ?>
                    <li><a href="<?= base_url('pelanggan/c_shopgrid/shop_kategori/' . $value->id_kategori) ?>"><?= $value->nama_kategori ?></a></li>
                <?php
                }
                ?>
                    ...
                    <div class="single-product-wrapper">
                        ...
                        <div class="product-description d-flex align-items-center justify-content-between">
                            ...
                            <div class="product-meta-data">
                                <div class="line"></div>
                                <p class="product-price">Rp. <?= number_format($value->harga_produk, 0) ?></p>
